...
<form action="vehicle.vrs?action=edit" method="post" >
    <table width="550" border="0" cellpadding="5" cellspacing="1" class="entryTable">
      <tr id="listTableHeader">
        <th  colspan="2" >Update Vehicle Details</th>
      </tr>
	  
	  <tr>
      	<input type="hidden" name="userId" value="<%=v.getUser().getId()%>" />
      	<input type="hidden" name="vehId" value="<%=v.getId()%>" />
        ...
        <td height="30" class="content">
            <input name="name" type="text" size="30" maxlength="30" 
            	value="<%=v.getUser().getName()%>" readonly="readonly" />
		</td>
      </tr>
	  ...
	  <tr>
        ...
        <td height="30" class="content">		
        <span id="sprytf_src">
            <input name="source" type="text" size="30" maxlength="20" value="<%=v.getSource()%>" />
            <br/>
	  ...
	  <tr>
        ...
        <td height="30" class="content">
        <span id="sprytf_cat">
            <input name="category" type="text" size="30" maxlength="20" value="<%=v.getCategory()%>" />
             <br/>
	  ...
	  <tr>
        ...
        <td height="30" class="content">
        <span id="sprytf_pla">
            <input name="plateNumber" type="text" size="20" maxlength="20" value="<%=v.getPlateNumber()%>" />
             <br/>
      ...
      <tr>
        ...
        <td height="30" class="content">
        <span id="sprytf_man">
            <input name="manufacture" type="text" size="20" maxlength="20" value="<%=v.getManufacture()%>" />
             <br/>
      ...
      <tr>
        ...
        <td height="30" class="content">
        <span id="sprytf_col">
            <input name="color" type="text" size="20" maxlength="20" value="<%=v.getColor()%>" />
             <br/>
      ...
      <tr>
        ...
        <td height="30" class="content">
        <span id="sprytf_reg">
            <input name="registrationDate" type="text" size="20" maxlength="20" value="<%=v.getRegistrationDate()%>" />
      ...
      <tr>
        ...
        <td height="30" class="content">
        <span id="sprytf_pen">
            <input name="pendingFines" type="text" size="30" maxlength="20" value="<%=v.getPendingFines()%>"/>
             <br/>
      ...
      <tr>
        <td height="30">&nbsp;</td>
        <td height="30"><input type="submit" value="Edit Vehicle Detail" /></td>
      </tr>
	</table>
</form>
